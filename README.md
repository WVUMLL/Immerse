...
- [ ] Quick cards: Paste into a textfield to quickly generate cards without making a text document
- [ ] Adding cards to existing decks

# How to Install

⚠️ This program is intended for WVU HSC students and assumes your device is a MacBook provided by the school (2025 M4 MacBook Air with 16 GB of memory) ⚠️
